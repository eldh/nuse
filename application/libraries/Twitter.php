...
class Twitter {
	 ...
	 * @var array
	 */
	var $headers=array('X-Twitter-Client: PHPTwitter Codeigniter','X-Twitter-Client-Version: 0.1','X-Twitter-Client-URL: http://nuse.se/');
	...
	/**
	 * The result type (mixed, recent, popular)
	 * @var string
	 */
	var $result_type;
	...
	*/
	function Twitter($params = array('search' => false)) {
